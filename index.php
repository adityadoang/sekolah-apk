...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
      ...
      <!--<div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="assets/images/logo.jpg" alt="AdminLTELogo" height="60" width="60">
        </div>-->
        ...
        <aside class="main-sidebar sidebar-dark-info elevation-4 ">
            ...
            <a href="#" class="brand-link ">
                <img src="assets/images/logo.jpg" alt="webpro" class="brand-image img-circle elevation-3" style="opacity: .8">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="assets/images/adit.jpg" class="img-circle elevation-1" alt="User Image">
                    </div>
                    <div class="info">
